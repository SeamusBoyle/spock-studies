...
obj.exec = function (period) {
  ...
  var macd = obj._fast[period] - obj._slow[period]
  var signal_
  ...
  if (period === obj._slowPeriods.value + obj._signalPeriods.value) {
    ...
    var macdHistory = obj._macdCurve.output.slice(period - obj._signalPeriods.value, period - 1)
  ...
  var histogram = macd !== undefined && signal_ !== undefined ? macd - signal_ : null
