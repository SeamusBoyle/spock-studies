...
obj.exec = function (period) {
  ...
  var prices = Plot.getTicks(period, obj._slowPeriods.value)
  if (prices == null) {
    return
  }

  var slowMa = Plot.sma(prices, obj._slowPeriods.value)
  var fastMa = Plot.sma(prices, obj._fastPeriods.value)
  ...
  var didChange = obj._isSlowUnder[period - 1] != obj._isSlowUnder[period - 2]
  if (!didChange) {
    return
  }
